...
class JsReceiveManager {
   ...
   * 收到消息
   */
  void receiveMsg(BuildContext context, String jsonMsg, Function method) {
    ...
    switch (type) {
      case 1001:
        _receive1001(context, type, data, method);
        break;
      case 1002:
        _receive1002(context, type, data, method);
        break;
      case 1003:
        _receive1003(context, type, data, method);
        break;
      case 1004:
        _receive1004(context, type, data, method);
        break;
      case 2001:
        _receive2001(context, type, data, method);
        break;
      case 2002:
        _receive2002(context, type, data, method);
        break;
      case 1001:
        _receive4001(context, type, data, method);
        break;
    }
  }
   ...
   * 1001 : 打开图片选择页面
   */
  void _receive1001(BuildContext context, int type, Map<String, dynamic> data,
   ...
   * 1002 : 打开修改手机号页面
   */
  void _receive1002(BuildContext context, int type, Map<String, dynamic> data,
      Function method) {
    NavigatorUtil.navigateTo(context, Routes.changePhomeNumber);
  }

  /**
   * 1003 : 打开新js链接页面
   */
  void _receive1003(BuildContext context, int type, Map<String, dynamic> data,
      Function method) {}

  /**
   * 1004 : 打开扫码页面
   */
  void _receive1004(BuildContext context, int type, Map<String, dynamic> data,
      Function method) {}

  /**
   * 2001 : 关闭页面
   */
  void _receive2001(BuildContext context, int type, Map<String, dynamic> data,
      Function method) {}

  /**
   * 2002 : 关闭页面并刷新
   */
  void _receive2002(BuildContext context, int type, Map<String, dynamic> data,
      Function method) {}

  /**
   * 4001 : 获取定位信息
   */
  void _receive4001(BuildContext context, int type, Map<String, dynamic> data,
      Function method) {}
